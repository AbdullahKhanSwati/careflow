...
import type { Branch, Status, FacilityType } from '@/types';
    ...
    <form onSubmit={handleSubmit} className="space-y-6">
      ...
      <div className="space-y-4">
        ...
        <div className="grid gap-4 sm:grid-cols-2">
          ...
          <FormInput
            label="Website"
            type="url"
            placeholder="e.g., https://www.branch.com"
      ...
      <div className="flex justify-end gap-3 pt-4">
        ...
        <Button type="submit" disabled={isLoading}>
          {isLoading ? 'Saving...' : initialData?.title ? 'Update Branch' : 'Create Branch'}
        </Button>
      </div>
    </form>
  );
